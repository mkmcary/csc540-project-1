...
/**
 * Displays the Customer Review page.  The customer can leave a review for the brand
 * to earn points in their program.
 * 
...
public class CustomerReview {
	...
	/**
	 * Constructs a new Customer Review page.  The customer can leave a review for the brand
	 * to earn points in their program.
	 * 
	 ...
	 */
	public CustomerReview(Connection conn, int walletId, int pid, int ruleVersion, String ruleCode, int pointsToEarn, List<Integer> tierThresholds) {
		...
		while (!done) {
			try {
				...
				// Get info on the review
				System.out.print("Enter content of your review: ");
